 ...
 */
public class ArenaPhaseNexusMultiplierButton extends Button {

    private final Phase phase;

    public ArenaPhaseNexusMultiplierButton(Phase phase) {
        this.phase = phase;
    }
    ...
    public ItemStack getItemStack(Player player) {
        return new ItemBuilder(Material.INK_SACK)
                .setDisplayName("&6Phase Nexus Multiplier")
                .setLore("&7Haz clic para &aactivar&7/&cdesactivar &7esta opción.")
                .setData(phase.isNexusMultiplier() ? 10 : 8)
                .build();
    }
    ...
    public void clicked(Player player, int slot, ClickType clickType, int hotbarButton) {
        playNeutral(player);
        phase.setNexusMultiplier(!phase.isNexusMultiplier());
    }
