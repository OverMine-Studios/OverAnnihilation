package dev.risas.dencore.utilities.command;
...
public class CommandArgs {
    ...
    public CommandArgs(CommandSender sender, org.bukkit.command.Command command, String label, String[] args, int subCommand) {
